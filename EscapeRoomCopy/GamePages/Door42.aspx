<%@ Page Title="" Language="C#" MasterPageFile="~/GamePages/GameMaster.Master" AutoEventWireup="true" CodeBehind="Door42.aspx.cs" Inherits="EscapeRoomCopy.GamePages.Door42" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="rectangle">
        <h1>tfel ot thgir morf siht daer ot deen uoY</h1>
        <h2>owt rebmun si rood txen</h2>
    </div>
    <a href="Door09.aspx">
