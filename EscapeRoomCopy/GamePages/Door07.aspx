<%@ Page Title="" Language="C#" MasterPageFile="~/GamePages/GameMaster.Master" AutoEventWireup="true" CodeBehind="Door07.aspx.cs" Inherits="EscapeRoomCopy.GamePages.Door07" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="rectangle">
        <h1>Time to learn some Python!</h1>
        <h2>What does this command prints: print(chr(51))</h2>
    </div>
    <a href="Door35.aspx">
