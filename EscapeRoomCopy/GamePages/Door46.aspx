<%@ Page Title="" Language="C#" MasterPageFile="~/GamePages/GameMaster.Master" AutoEventWireup="true" CodeBehind="Door46.aspx.cs" Inherits="EscapeRoomCopy.GamePages.Door46" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="rectangle">
        <h2>In this level there is no right door, only a wrong one.</h2>
