<%@ Page Title="" Language="C#" MasterPageFile="~/GamePages/GameMaster.Master" AutoEventWireup="true" CodeBehind="Door22.aspx.cs" Inherits="EscapeRoomCopy.GamePages.Door22" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="rectangle">
        <h2>You can go the distance, you can run the mile</h2>
        <h2>You can walk straight through hell with a smile</h2>
